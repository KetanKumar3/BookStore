...
function Login() {
    ...
    const onSubmit = async (data) => {
        ...
        await axios.post("http://localhost:4200/user/login", userInfo)
            .then((res) => {
                ...
                <div className="modal-box">
                    <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                        ...
                        <div className='flex justify-around mt-4'>
                            <button className='bg-pink-500 rounded-md text-white px-3 py-1 hover:bg-pink-700 duration-300'>Login</button>
